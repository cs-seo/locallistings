...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // Resilient at build time: if Supabase isn't reachable, we still publish the
  // homepage entry. Listing/category URLs are added once data exists.
  try {
    ...
    console.warn("[sitemap] skipping listing URLs:", (err as Error).message);
  }
